...
# Connect the IHP SRAM's Metal4 power buses (VDD!, VDDARRAY!, VSS!) to the
# PDN stripes.  The default macro grid only bridges TopMetal1 ↔ TopMetal2;
# adding Metal4 ↔ TopMetal1 and Metal4 ↔ TopMetal2 lets pdngen generate the
# Via4→TopVia1(→TopVia2) stacks that physically land on the SRAM pin shapes.
add_pdn_connect \
    -grid macro \
